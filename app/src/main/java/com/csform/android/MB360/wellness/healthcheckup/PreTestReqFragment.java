...
import com.csform.android.MB360.databinding.FragmentPreTestReqBinding;
...
public class PreTestReqFragment extends Fragment {

    FragmentPreTestReqBinding binding;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentPreTestReqBinding.inflate(inflater, container, false);
        view = binding.getRoot();

        loadSessionViewModel = new ViewModelProvider(requireActivity()).get(LoadSessionViewModel.class);
        healthCheckupOverviewViewModel = new ViewModelProvider(PreTestReqFragment.this).get(HealthCheckupOverviewViewModel.class);
    ...
    private void getHealthCheckupPreTestReq() {
...
//        healthCheckupOverviewViewModel.getHealthCheckupOverview(externalGroupSrNo,agent);
        ...
        healthCheckupOverviewViewModel.getHealthCheckupOverviewData().observe(getViewLifecycleOwner(), healthCheckupOverviewResponse -> {
            ...
            binding.wvPreTestReq.loadDataWithBaseURL(null, healthCheckupOverviewResponse.getPreTestPolicy() + css_classes, "text/html", "UTF-8", "about:blank");
