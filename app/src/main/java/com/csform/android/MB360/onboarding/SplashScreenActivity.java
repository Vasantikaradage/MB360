package com.csform.android.MB360.onboarding;
...
import com.csform.android.MB360.onboarding.walkthrough.WalkThroughActivity;
...
public class SplashScreenActivity extends AppCompatActivity implements FridaListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkForUpdates();
        try {
            LogMyBenefits.d("SPLASHSCREEN", "ENCRYPTION: " + AesEncryption.decrypt(URLDecoder.decode("byYtAi6UPmaXuDHManBTtAHRDr7un%2Fapf%2BD%2FWnhueE%3D")));
