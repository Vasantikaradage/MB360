...
import com.csform.android.MB360.databinding.FragmentQueryFaqBinding;
import com.csform.android.MB360.insurance.queries.responseclass.QueryFaqModel;
    ...
    private void setupRecyclerView(int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                faqQueryList.add(new QueryFaqModel("In how many days do I get my card?", "E-cards are visible within 7-10 Working Days on MyBenefits360 Insurance portal from receipt of your Enrollment Details through HR or your Window Period Closure. The physical cards are dispatched to your HR, within 10-15 days from the receipt of enrollment details."));
                ...
                faqQueryList.add(new QueryFaqModel("I can't see my family members E-card?", "Either you have not provided your family members details to your HR for enrollment in the policy OR you have not added them on MyBenefits360 Insurance portal during Enrollment Window period."));
            ...
            case 2:
                ...
                faqQueryList.add(new QueryFaqModel("I got married recently. How do I add my spouse?", "Intimation of the same to be given to HR Team within 15 days of your date of marriage or the same can be updated on MyBenefits360 Insurance portal if enrollment option is provided."));
                faqQueryList.add(new QueryFaqModel("How do I add my new born baby?", "Intimation of the same to be given to HR Team within 15 days of your date of birth of your child or the same can be updated on MyBenefits360 Insurance portal if enrollment option is provided."));
            ...
            case 3:
                //policy features
                faqQueryList = new ArrayList<>();
                faqQueryList.add(new QueryFaqModel("What are my policy features and coverage details?", "Your Policy Terms and Coverage details are available in the Policy Features and My Coverages links in your Employee Login on MyBenefits360 Insurance app."));
            ...
            case 5:
                ...
                faqQueryList.add(new QueryFaqModel("Which hospitals can I avail cashless facility?", "Cashless hospitalizations facility can be availed in any of the Network Hospitals empanelled with your TPA. List of Network Hospitals can be found of MyBenefits360 Insurance portal under the Network Hosptials link."));
            ...
            case 6:
                ...
                faqQueryList.add(new QueryFaqModel("How do I know the status of reimbursement claim?", "On receipt of the Claim File by the TPA and subsequent processing of the same, the Employee will receive automated SMS and email of the same on their registered mobile number and email id from MyBenefits360 Insurance at all stages of claim process and settlement. Real time status of the claim is also available on MyBenefits360 Insurance under the Claim Status link."));
            ...
            case 7:
                //claim intimation
                faqQueryList = new ArrayList<>();
                faqQueryList.add(new QueryFaqModel("How to intimate claim?", "Claim can be intimated by filling up the Claim Intimation form under the Intimate Claim link on MyBenefits360 Insurance portal."));
            ...
            case 9:
                //contact Details
                faqQueryList = new ArrayList<>();
                faqQueryList.add(new QueryFaqModel("Who do I contact for my health insurance queries?", "Please refer the Contact Details link in MyBenefits360 Insurance portal for your Account Manager details. You can also raise a query ticket in the Employee Queries module. Your query will be resolved within 24 hrs of raising the query."));
                faqQueryList.add(new QueryFaqModel("What if my query is not answered?", "All queries raised on MyBenefits360 Insurance portal are answered. MyBenefits360 Insurance portal has a TAT of 24 hrs for query resolution."));
            ...
            case 10:
                faqQueryList = new ArrayList<>();
                String claimStatusString = "Yes - Insured  will receive automated SMS and email of claim on their registered mobile number and email id from MyBenefits360 Insurance at all stages of claim process and settlement. The stages of claim status are:\n" + "\n" + "                    i.) Claim Intimation\n" + "\n" + "                    ii.) Claim Acknowledgment Status\n" + "\n" + "                    iii.) Claim Deficiency Status\n" + "\n" + "                    iv.) Claim Deficiency Reminder\n" + "\n" + "                    v.) Claim Closure Status\n" + "\n" + "                    vi.) Claim Rejected Status\n" + "\n" + "                    vii.) Claim Settlement Letter";

                //claim tracking
                faqQueryList.add(new QueryFaqModel("How do I track my claim?", "Real time status of the claim is available of MyBenefits360 Insurance under the Claim Status link. Insured  will receive automated SMS and email of the same on their registered mobile number and email id from MyBenefits360 Insurance at all stages of claim process and settlement."));
