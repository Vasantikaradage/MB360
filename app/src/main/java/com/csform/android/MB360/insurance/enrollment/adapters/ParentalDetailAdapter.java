...
import com.csform.android.MB360.databinding.ItemEnrollmentDependantDetailsBinding;
import com.csform.android.MB360.databinding.ItemParentalHeaderBinding;
import com.csform.android.MB360.insurance.enrollment.interfaces.DependantHelper;
import com.csform.android.MB360.insurance.enrollment.interfaces.ParentalDetailsHelper;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder.getItemViewType() == 0) {
            ...
            if (dependantHelperModel.getIsAdded()) {
                ...
                if(parentList.get(position).isCanEdit()) {
                    //edit image
                    ...
                    ((ParentalDetailViewHolder) holder).binding.itemDependantForeground.rlSave.setImageDrawable(ContextCompat.getDrawable(context, android.R.color.transparent ));
