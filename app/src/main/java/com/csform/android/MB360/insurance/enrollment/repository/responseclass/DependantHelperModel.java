...
public class DependantHelperModel {
    ...
    public DependantHelperModel(String relationName, Integer maxCount, String group, Boolean isAdded,
                                String name,
                                String dateOfBirth, Boolean isDifferentlyAble, File document, String age, Boolean canEdit, Boolean canDelete, String gender, String relationId,String twins) {
    ...
    public DependantHelperModel(String relationName, Integer maxCount, String group, Boolean isAdded,
                                String name,
                                String dateOfBirth, Boolean isDifferentlyAble, File document, String age, Boolean canEdit, Boolean canDelete, String gender, String personSrNo, String pair_no,String relationId,String twins) {
        this.relationName = relationName;
        this.maxCount = maxCount;
        this.group = group;
        this.isAdded = isAdded;
