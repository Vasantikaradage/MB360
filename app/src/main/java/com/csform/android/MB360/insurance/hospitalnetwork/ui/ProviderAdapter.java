package com.csform.android.MB360.insurance.hospitalnetwork.ui;
...
import com.csform.android.MB360.databinding.ItemNetworkProviderBinding;
...
public class ProviderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ((ProviderViewHolder) holder).binding.imgPhone.setColorFilter(ContextCompat.getColor(this.context, R.color.gradient_end));
        ((ProviderViewHolder) holder).binding.IVloc.setColorFilter(ContextCompat.getColor(this.context, R.color.gradient_end));
        ...
        switch (listItem.getHospLevelOfCare()) {
            case "Primary":
                ...
                ((ProviderViewHolder) holder).binding.v1.setBackgroundColor(ContextCompat.getColor(this.context, R.color.gradient_end));
                ((ProviderViewHolder) holder).binding.tvPC.setTextColor(ContextCompat.getColor(this.context, R.color.gradient_end));
                ((ProviderViewHolder) holder).binding.llbadge.setBackgroundResource(R.drawable.badge_blue);
                break;

            case "Secondary":
                ((ProviderViewHolder) holder).binding.tvPC.setText("Secondary Care");
                ((ProviderViewHolder) holder).binding.v1.setBackgroundColor(ContextCompat.getColor(this.context, R.color.green));
                ((ProviderViewHolder) holder).binding.tvPC.setTextColor(ContextCompat.getColor(this.context, R.color.green));
                ((ProviderViewHolder) holder).binding.llbadge.setBackgroundResource(R.drawable.badge_green_1);

                break;

            case "Tertiary":
                ((ProviderViewHolder) holder).binding.tvPC.setText("Tertiary Care");
                ((ProviderViewHolder) holder).binding.v1.setBackgroundColor(ContextCompat.getColor(this.context, R.color.tc));
                ((ProviderViewHolder) holder).binding.tvPC.setTextColor(ContextCompat.getColor(this.context, R.color.tc));
                ((ProviderViewHolder) holder).binding.llbadge.setBackgroundResource(R.drawable.badge_red);
                break;
            ...
            default:
                ...
                ((ProviderViewHolder) holder).binding.llbadge.setBackgroundResource(R.drawable.badge_yellow);
                break;
        }
