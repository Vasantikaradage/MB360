...
public class ChallengeLayoutItems implements Serializable {
    ...
    public ChallengeLayoutItems(String challenge_type, String challenge_name,
    ...
    public ChallengeLayoutItems(String challenge_type, String challenge_name, String challenge_time,
