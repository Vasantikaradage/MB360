...
import com.csform.android.MB360.databinding.ItemElderCareBinding;
import com.csform.android.MB360.utilities.LogMyBenefits;
import com.csform.android.MB360.utilities.LogTags;
import com.csform.android.MB360.utilities.UtilMethods;
import com.csform.android.MB360.wellness.homehealthcare.responseclass.ElderCell;
...
public class ElderCarePackagesAdaptor extends RecyclerView.Adapter<ElderCarePackagesAdaptor.ElderCarePackageViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ElderCarePackageViewHolder holder, int position) {
        ...
        LogMyBenefits.d(LogTags.ELDER_CARE, "onBindViewHolder: " + packageECList.get(position).getCategory());
