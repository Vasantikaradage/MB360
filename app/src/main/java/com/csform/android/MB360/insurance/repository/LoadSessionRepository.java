package com.csform.android.MB360.insurance.repository;
                ...
                public void onResponse(Call<LoadSessionResponse> call, Response<LoadSessionResponse> response) {
                    ...
                    if (response.code() == 200) {
                        try {
                           ...
                           /* response.body().getGroupInfoData().setGroupcode("MAT");
                            response.body().getGroupInfoData().setGroupname("Mobile App Test");
                            response.body().getGroupInfoData().setGroupchildsrno("1385");
                            response.body().getGroupPoliciesEmployees().get(0).getGroupGMCPolicyEmployeeData().get(0).setEmployeeSrNo("THYNK018");
                            response.body().getGroupPoliciesEmployees().get(0).getGroupGMCPolicyEmployeeData().get(0).setEmployeeIdentificationNo("THYNK018");
                                ...
                                public void onResponse(Call<LoadSessionResponse> call, Response<LoadSessionResponse> response) {
                                    if (response.code() == 200) {
                                        try {
                                            ...
                                            if(response.body().getMessage().equals("LoadSession Details found"))
                                            {
                                                loadSessionResponseMutableLiveData.setValue(response.body());
                                                loadingState.setValue(false);
                                                errorState.setValue(false);
