...
import com.csform.android.MB360.insurance.coverages.repository.retrofit.CoveragesApi;
...
import com.csform.android.MB360.wellness.homehealthcare.cancellation.CancellationApi;
    ...
    public HomeHealthCareRetrofitClient() { // constructor
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(chain -> {
                    ...
                    LogMyBenefits.d(LogTags.GET_MEMBERS, newRequest.url().toString());
