...
import com.csform.android.MB360.databinding.FragmentProfileWellnessBinding;
...
import com.csform.android.MB360.insurance.profile.ui.DocumentOnClickListener;
import com.csform.android.MB360.insurance.profile.ui.ProfileDocumentAdapter;
...
public class ProfileWellnessFragment extends Fragment implements DocumentOnClickListener {
    ...
    FragmentProfileWellnessBinding binding;
    View view;
    ...
    public ProfileWellnessFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentProfileWellnessBinding.inflate(inflater, container, false);
...
//personal information
        ...
        binding.logoutbtn.setOnClickListener(v -> {
            ...
            dialog.setContentView(R.layout.smslayout_wellness);
    ...
    private void loadProfile() {
        ...
        profileViewModel.getProfileData().observe(getViewLifecycleOwner(), profileResponse -> {
            ...
            if (profileResponse != null) {
                ...
                binding.lblEmail.setText(profileResponse.getUserPersonalDetails().getEMailId());
    ...
    private void logout() {
        ...
        editor.putString(BuildConfig.AUTH_LOGIN_ID, null);
        editor.putString(BuildConfig.AUTH_EMAIL, null);
        editor.putString(BuildConfig.AUTH_PHONE_NUMBER, null);
        editor.putString(BuildConfig.AUTH_LOGIN_TYPE, null);
        editor.apply();
...
//navigate to upload fragment
    ...
    private void uploadDocuments(Context context, String docType) {
        ...
        bottomSheetDialog.setContentView(R.layout.fragment_upload_documents_profile_dialog_wellness);
