...
public class TrainedAttendantAdapter extends RecyclerView.Adapter<TrainedAttendantAdapter.TrainedAttendantViewHolder> {
    List<OnGoingSummaryNA> summaryList;
    Context context;
    String serviceName;
    ...
    public TrainedAttendantAdapter(List<OnGoingSummaryNA> summaryList, Context context, String serviceName, OnCancellation onCancellation, RescheduleInterface rescheduleInterface) {
    ...
    @NonNull
    @Override
    public TrainedAttendantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemAppointmentBinding binding = ItemAppointmentBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new TrainedAttendantViewHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull TrainedAttendantViewHolder holder, int position) {
        try {
            String strApptSrNo = "";
            ...
            holder.binding.txtAppointReference.setText(summaryList.get(position).getHhcApptInfoSrNo());
        ...
        holder.binding.btnreschedule.setOnClickListener(view -> {
            ...
            rescheduleInterface.rescheduleAppointmentNA(summaryList.get(position));
    ...
    public static class TrainedAttendantViewHolder extends RecyclerView.ViewHolder {
        ItemAppointmentBinding binding;

        public TrainedAttendantViewHolder(@NonNull ItemAppointmentBinding binding) {
