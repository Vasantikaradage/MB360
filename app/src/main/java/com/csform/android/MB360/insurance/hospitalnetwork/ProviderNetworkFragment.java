package com.csform.android.MB360.insurance.hospitalnetwork;
...
import com.csform.android.MB360.databinding.FragmentProviderNetworkBinding;
...
import com.csform.android.MB360.insurance.hospitalnetwork.ui.OnHospitalSelectedListener;
import com.csform.android.MB360.insurance.hospitalnetwork.ui.ProviderAdapter;
...
public class ProviderNetworkFragment extends Fragment implements OnHospitalSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //TODO make this work when we get the api!
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        hospitalNetworkViewModel.getReloginState().observe(getActivity(), relogin -> {
            if (relogin) {
    ...
    private void filterOther() {
        ...
        filteredHospitals = nonFilteredHospital.stream().filter(hospital -> (hospital.getHospLevelOfCare().equalsIgnoreCase("-"))).collect(Collectors.toList());
        adapter = new ProviderAdapter(requireContext(), filteredHospitals, this);
        adapter.notifyItemRangeChanged(0, filteredHospitals.size());
        binding.hospitalCycle.setAdapter(adapter);
