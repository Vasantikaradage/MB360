package com.csform.android.MB360.insurance.escalations;
...
import com.csform.android.MB360.databinding.FragmentSupportBinding;
import com.csform.android.MB360.insurance.dialogues.PolicyChangeDialogue;
import com.csform.android.MB360.insurance.escalations.repository.EscalationsViewModel;
import com.csform.android.MB360.insurance.escalations.repository.responseclass.EscalationsResponse;
import com.csform.android.MB360.insurance.escalations.repository.ui.EscalationAdapter;
        ...
        selectedPolicyViewModel.getSelectedPolicy().observe(getViewLifecycleOwner(), policy -> {
            ...
            escalationsViewModel.getEscalationsData().observe(getViewLifecycleOwner(), escalationsResponse -> {
                ...
                if (escalationsResponse != null) {
                    adapter = new EscalationAdapter(requireContext(), escalationsResponse.getGroupEscalationInfo());
