...
import com.csform.android.MB360.databinding.FragmentDiagnosticBinding;
...
public class DiagnosticFragment extends Fragment implements OnDiagnosticCenterSelected {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        appointmentHealthCheckup = DiagnosticFragmentArgs.fromBundle(getArguments()).getAppointmentHealthCheckupPackage();
        ...
        loadSessionViewModel.getLoadSessionData().observe(requireActivity(), loadSessionResponse -> {
            ...
            packagesViewModel.getCitiesLiveDataHC().observe(getViewLifecycleOwner(), cityLive -> {
                if (cityLive != null) {
                    ...
                    LogMyBenefits.e(LogTags.HEALTH_CHECKUP_ACTIVITY, "getDiagnosticCenter: NULL");
    ...
    public void onDiagnosticSelected(DiagnosticCenter diagnosticCenter) {
        ...
        NavDirections action = DiagnosticFragmentDirections.actionDiagnosticFragmentToPrefDateFragment().setAppointmentHealthCheckUp(appointmentHealthCheckup).setDiagnosticCenterNo(diagnosticCenter);
