...
public class SummaryAdapter extends RecyclerView.Adapter<SummaryAdapter.SummaryViewHolder> {
    ...
    List<OnGoingSummaryEC> summaryEcList;
    Context context;
    String serviceName;
    ...
    public SummaryAdapter(Context context, String serviceName, OnCancellation onCancellation, RescheduleInterface rescheduleInterface) {
    ...
    //setters of the summary data list


    public void setSummaryList(List<ScheduledSummary> summaryList) {
        this.summaryList = summaryList;
    }

    public void setSummaryEcList(List<OnGoingSummaryEC> summaryEcList) {
        this.summaryEcList = summaryEcList;
    }
                    ...
                    if (summaryList.get(position).getNaDurations().equals("Monthly")) {
                        ...
                        if (strFromDate.contains(",")) {
                            ...
                            while (mystrToken.hasMoreTokens()) {
                                ...
                                LogMyBenefits.d("DATESSS", datesstr);
                            }
