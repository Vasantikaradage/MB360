package com.csform.android.MB360.onboarding.walkthrough;


import static com.csform.android.MB360.BuildConfig.AUTH_FIRST_TIME_USER;
...
import com.csform.android.MB360.databinding.ActivityWalkThroughBinding;
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            switch (position) {
                case 0:
                    ...
                    imgtitle.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.enroll));
                    break;

                case 1:
                    title.setText("PERSONALIZE");
                    detailtxt.setText(R.string.personalize);
                    imgtitle.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.personalize));
                    break;
                case 2:
                    title.setText("MANAGE");
                    detailtxt.setText(R.string.manage);
                    imgtitle.setImageDrawable(ContextCompat.getDrawable(context, R.drawable.manage));
                    break;
