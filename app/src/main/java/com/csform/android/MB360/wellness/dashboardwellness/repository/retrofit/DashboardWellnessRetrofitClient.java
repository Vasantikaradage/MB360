package com.csform.android.MB360.wellness.dashboardwellness.repository.retrofit;
    ...
    public DashboardWellnessRetrofitClient() {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .addInterceptor(chain -> {
                    ...
                    LogMyBenefits.d(LogTags.WELLNESS_DASHBOARD_ACTIVITY, newRequest.url().toString());
