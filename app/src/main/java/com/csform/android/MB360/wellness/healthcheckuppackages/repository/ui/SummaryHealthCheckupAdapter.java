...
import com.csform.android.MB360.databinding.ItemOngoingHealthcheckupBinding;
        ...
        try {
            ...
            switch (appointmentHealthCheckupList.get(position).getStatus()) {
                ...
                case "REJECTED": {
                    ...
                    holder.binding.tvschedates.setTextColor(ContextCompat.getColor(context, R.color.statusreject));
                }
                break;
            ...
            if (appointmentHealthCheckupList.get(position).getStatus().equalsIgnoreCase("SCHEDULED")) {
                ...
                holder.binding.tvscheduledon.setText(Html.fromHtml(appointmentHealthCheckupList.get(position).getRemark(), Html.FROM_HTML_MODE_COMPACT));
...
//                }
        ...
        holder.binding.cancelLL.setOnClickListener(v -> {
            onCancellationHealthCheckup.cancelAppointmentHC(position, appointmentHealthCheckupList.get(position));
        });
