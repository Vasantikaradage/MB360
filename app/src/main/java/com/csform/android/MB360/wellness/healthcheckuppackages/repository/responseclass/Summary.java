...
public class Summary {
    ...
    @Expose
    private List<SelfSponseredPerson> companySponseredPerson = null;
    ...
    public List<SelfSponseredPerson> getCompanySponseredPerson() {
        return companySponseredPerson;
    }

    public void setCompanySponseredPerson(List<SelfSponseredPerson> companySponseredPerson) {
    ...
    public String toString() {
        return "Summary{" +
                "selfSponseredPerson=" + selfSponseredPerson +
                ", companySponseredPerson=" + companySponseredPerson +
