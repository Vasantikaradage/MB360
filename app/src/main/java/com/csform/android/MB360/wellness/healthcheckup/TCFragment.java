...
import com.csform.android.MB360.databinding.FragmentTCBinding;
...
public class TCFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        healthCheckupOverviewViewModel = new ViewModelProvider(TCFragment.this).get(HealthCheckupOverviewViewModel.class);
    ...
    private void getHealthCheckupTC() {
...
//        healthCheckupOverviewViewModel.getHealthCheckupOverview(externalGroupSrNo,agent);
        ...
        healthCheckupOverviewViewModel.getHealthCheckupOverviewData().observe(getViewLifecycleOwner(), healthCheckupOverviewResponse -> {
            ...
            binding.wvTC.loadDataWithBaseURL(null, healthCheckupOverviewResponse.getRefCanPolicy() + css_classes, "text/html", "UTF-8", "about:blank");
